...
const skipNetworkTimeoutTests =
  process.env.SKIP_NETWORK_TIMEOUT_TESTS === "true";
...
const utmParameters =
  "utm_source=attentive&utm_medium=sms&utm_campaign=campaign_1";
...
function validateOriginReferrer(requestParams) {
  expect(requestParams)
    ...
    .to.contain("localhost.test/path/name");
  expect(requestParams)
    .to.have.property("origin_referrer")
    .to.contain("utm_source=attentive");
  expect(requestParams)
    .to.have.property("origin_referrer")
    .to.contain("utm_medium=sms");
  expect(requestParams)
    .to.have.property("origin_referrer")
    .to.contain("utm_campaign=campaign_1");
}
...
describe(`ConstructorIO - Tracker${bundledDescriptionSuffix}`, () => {
  ...
  describe("trackSessionStart", () => {
    ...
    it("Should send along document_referrer and canonical_url query param", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(fetchSpy).to.have.been.called;
        expect(requestParams)
          .to.have.property("canonical_url")
          .to.equal(canonicalUrl);
        expect(requestParams)
          .to.have.property("document_referrer")
          .to.equal(referrer);
    ...
    it("Should respond with a valid response with multiple testCells", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(Object.values(testCells)[0]);
        expect(requestParams)
          .to.have.property(`ef-${Object.keys(testCells)[1]}`)
          .to.equal(Object.values(testCells)[1]);
        expect(requestParams)
          .to.have.property(`ef-${Object.keys(testCells)[2]}`)
          .to.equal(Object.values(testCells)[2]);
  ...
  describe("trackAutocompleteSelect", () => {
    ...
    it("V2 Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(requiredParameters.section);
        validateOriginReferrer(requestParams);

        // Body
        expect(bodyParams)
          .to.have.property("user_input")
          .to.equal(requiredParameters.originalQuery);
        expect(bodyParams)
          .to.have.property("tr")
          .to.equal(optionalParameters.tr);
        expect(bodyParams)
          .to.have.property("item_id")
          .to.equal(optionalParameters.itemId);
        expect(bodyParams)
          .to.have.property("variation_id")
          .to.equal(v2Parameters.variationId);
        expect(bodyParams)
          .to.have.property("section")
          .to.deep.equal(requiredParameters.section);
        expect(bodyParams).to.have.property("item_name").to.equal(term);
        expect(bodyParams)
          .to.have.property("group_id")
          .to.equal(optionalParameters.groupId);
        expect(bodyParams)
          .to.have.property("sl_campaign_id")
          .to.equal(optionalParameters.slCampaignId);
        expect(bodyParams)
          .to.have.property("sl_campaign_owner")
          .to.deep.equal(optionalParameters.slCampaignOwner);
      ...
      expect(
        tracker.trackAutocompleteSelectV2(term, {
          ...requiredParameters,
          ...optionalParameters,
          ...v2Parameters,
        }),
    ...
    it("Backwards Compatibility - V2 Should respond with a valid response when snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(bodyParams)
          .to.have.property("user_input")
          .to.equal(snakeCaseParameters.original_query);
        expect(bodyParams)
          .to.have.property("tr")
          .to.equal(optionalParameters.tr);
        expect(bodyParams)
          .to.have.property("item_id")
          .to.equal(snakeCaseParameters.item_id);
        expect(bodyParams)
          .to.have.property("variation_id")
          .to.equal(snakeCaseParameters.variation_id);
        expect(bodyParams)
          .to.have.property("section")
          .to.deep.equal(snakeCaseParameters.section);
        expect(bodyParams).to.have.property("item_name").to.equal(term);
        expect(bodyParams)
          .to.have.property("group_id")
          .to.equal(optionalParameters.groupId);
    ...
    it("Backwards Compatibility - Should respond with a valid response when snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        validateOriginReferrer(requestParams);
        expect(requestParams)
          .to.have.property("original_query")
          .to.equal(snakeCaseParameters.original_query);
        expect(requestParams)
          .to.have.property("item_id")
          .to.equal(snakeCaseParameters.item_id);
        expect(requestParams)
          .to.have.property("section")
          .to.equal(snakeCaseParameters.section);
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(
        tracker.trackAutocompleteSelect(term, requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should respond with a valid response when term, required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("sl_campaign_id")
          .to.deep.equal(optionalParameters.slCampaignId);
      ...
      expect(
        tracker.trackAutocompleteSelect(term, {
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    it("Should throw an error when invalid term is provided", () => {
      ...
      expect(tracker.trackAutocompleteSelect([], requiredParameters)).to.be.an(
        "error",
      );
    });
    ...
    it("Should throw an error when no term is provided", () => {
      ...
      expect(
        tracker.trackAutocompleteSelect(null, requiredParameters),
      ).to.be.an("error");
    });
    ...
    it("Should properly encode path parameter", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestUrl).to.include(
          encodeURIComponent(termSpecialCharacters),
        );
      ...
      expect(
        tracker.trackAutocompleteSelect(
          termSpecialCharacters,
          requiredParameters,
        ),
      ).to.equal(true);
    });
  ...
  describe("trackItemDetailLoad", () => {
    ...
    it("Backwards Compatibility - Should respond with a valid response when snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(snakeCaseParameters.item_id);
        expect(requestParams)
          .to.have.property("item_name")
          .to.equal(snakeCaseParameters.item_name);
        expect(requestParams)
          .to.have.property("variation_id")
          .to.equal(snakeCaseParameters.variation_id);
        validateOriginReferrer(requestParams);
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("item_id")
          .to.equal(requiredParameters.itemId);
        expect(requestParams)
          .to.have.property("item_name")
          .to.equal(requiredParameters.itemName);
        validateOriginReferrer(requestParams);
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("variation_id")
          .to.deep.equal(optionalParameters.variationId);
        expect(requestParams)
          .to.have.property("analytics_tags")
          .to.deep.equal(testAnalyticsTag);
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackItemDetailLoad(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackSearchSubmit", () => {
    ...
    it("Backwards Compatibility - V2 Should respond with a valid response when term and snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(bodyParams.filters)
          .to.have.property("group_id")
          .to.equal(snakeCaseParameters.group_id);
      ...
      expect(tracker.trackSearchSubmitV2(term, snakeCaseParameters)).to.equal(
        true,
      );
    });
    ...
    it("V2 Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(
        tracker.trackSearchSubmitV2(term, {
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    it("Backwards Compatibility - Should respond with a valid response when term and snake cased parameters are provided", (done) => {
      ...
      expect(tracker.trackSearchSubmit(term, snakeCaseParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(tracker.trackSearchSubmit(term, requiredParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should send along document_referrer and canonical_url query param", (done) => {
      ...
      expect(
        tracker.trackSearchSubmit(term, {
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    it("Should throw an error when invalid term is provided", () => {
      ...
      expect(tracker.trackSearchSubmit([], requiredParameters)).to.be.an(
        "error",
      );
    });
    ...
    it("Should throw an error when no term is provided", () => {
      ...
      expect(tracker.trackSearchSubmit(null, requiredParameters)).to.be.an(
        "error",
      );
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackSearchSubmit(term, requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
    ...
    it("Should properly encode path parameter", (done) => {
      ...
      expect(
        tracker.trackSearchSubmit(termSpecialCharacters, requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should properly obfuscate PII in a path parameter", (done) => {
      ...
      expect(
        tracker.trackSearchSubmit(termWithPII, { originalQuery: termWithPII }),
      ).to.equal(true);
    });
    ...
    it("Should properly obfuscate PII in a query parameter", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("original_query")
          .to.equal(replaceWith);
        expect(requestParams)
          .to.have.property("original_query")
          .to.not.include(termWithPII);
  ...
  describe("trackSearchResultsLoaded", () => {
    ...
    it("Backwards Compatibility - Should respond with a valid response when term and snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        // Body
        expect(bodyParams)
          .to.have.property("result_count")
          .to.equal(snakeCaseParameters.num_results);
        expect(bodyParams)
          .to.have.property("url")
          .to.equal(snakeCaseParameters.url);
        expect(bodyParams)
          .to.have.property("result_page")
          .to.equal(snakeCaseParameters.result_page);
        expect(bodyParams)
          .to.have.property("result_id")
          .to.equal(snakeCaseParameters.result_id);
        expect(bodyParams)
          .to.have.property("sort_order")
          .to.equal(snakeCaseParameters.sort_order);
        expect(bodyParams)
          .to.have.property("sort_by")
          .to.equal(snakeCaseParameters.sort_by);
        expect(bodyParams)
          .to.have.property("selected_filters")
          .to.deep.equal(snakeCaseParameters.selected_filters);
        expect(bodyParams)
          .to.have.property("section")
          .to.deep.equal(snakeCaseParameters.section);
        expect(bodyParams)
          .to.have.property("items")
          .to.deep.equal(transformedItems);
    ...
    it("Should respond with a valid response when term and parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(bodyParams)
          .to.have.property("result_count")
          .to.equal(requiredParameters.numResults);
        expect(bodyParams).to.have.property("url").to.equal(v2Parameters.url);
        expect(bodyParams)
          .to.have.property("result_page")
          .to.equal(v2Parameters.resultPage);
        expect(bodyParams)
          .to.have.property("result_id")
          .to.equal(v2Parameters.resultId);
        expect(bodyParams)
          .to.have.property("sort_order")
          .to.equal(v2Parameters.sortOrder);
        expect(bodyParams)
          .to.have.property("sort_by")
          .to.equal(v2Parameters.sortBy);
        expect(bodyParams)
          .to.have.property("selected_filters")
          .to.deep.equal(v2Parameters.selectedFilters);
        expect(bodyParams)
          .to.have.property("section")
          .to.deep.equal(v2Parameters.section);
        expect(bodyParams)
          .to.have.property("analytics_tags")
          .to.deep.equal(v2Parameters.analyticsTags);
        expect(bodyParams)
          .to.have.property("items")
          .to.deep.equal(
            v2Parameters.items.map((item) =>
              clientHelpers.toSnakeCaseKeys(item, false),
            ),
          );
      ...
      // eslint-disable-next-line max-len
      expect(
        tracker.trackSearchResultsLoaded(term, {
          ...requiredParameters,
          ...v2Parameters,
        }),
      ).to.equal(true);
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(
        tracker.trackSearchResultsLoaded(term, requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should respond with a valid response when term and legacy parameters are provided", (done) => {
      ...
      expect(tracker.trackSearchResultsLoaded(term, legacyParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when term, and zero value num_results parameter are provided", (done) => {
      ...
      expect(
        tracker.trackSearchResultsLoaded(term, { num_results: 0 }),
      ).to.equal(true);
    });
    ...
    it("Should trim term parameter if extra spaces are provided", (done) => {
      ...
      expect(
        tracker.trackSearchResultsLoaded(spaceTerm, requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should throw an error when invalid term is provided", () => {
      ...
      expect(tracker.trackSearchResultsLoaded([], requiredParameters)).to.be.an(
        "error",
      );
    });
    ...
    it("Should throw an error when no term is provided", () => {
      ...
      expect(
        tracker.trackSearchResultsLoaded(null, requiredParameters),
      ).to.be.an("error");
    });
  ...
  describe("trackSearchResultClick", () => {
    ...
    it("Backwards Compatibility - V2 Should respond with a valid response when term and snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(bodyParams)
          ...
          .to.equal(snakeCaseParameters.result_page);
        expect(bodyParams)
          .to.have.property("result_position_on_page")
          .to.equal(snakeCaseParameters.result_position_on_page);
        expect(bodyParams)
          .to.have.property("result_count")
          .to.equal(snakeCaseParameters.result_count);
        expect(bodyParams)
          .to.have.property("num_results_per_page")
          .to.equal(snakeCaseParameters.num_results_per_page);
        expect(bodyParams)
          .to.have.property("selected_filters")
          .to.deep.equal(snakeCaseParameters.selected_filters);
    ...
    it("V2 Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(bodyParams)
          .to.have.property("variation_id")
          .to.equal(optionalParameters.variationId);
        expect(bodyParams)
          .to.have.property("section")
          .to.deep.equal(optionalParameters.section);
        expect(bodyParams)
          .to.have.property("sl_campaign_id")
          .to.equal(optionalParameters.slCampaignId);
        expect(bodyParams)
        ...
        expect(bodyParams)
          .to.have.property("result_position_on_page")
          .to.equal(v2Parameters.resultPositionOnPage);
        expect(bodyParams)
          .to.have.property("result_count")
          .to.equal(v2Parameters.resultCount);
        expect(bodyParams)
          .to.have.property("num_results_per_page")
          .to.equal(v2Parameters.numResultsPerPage);
        expect(bodyParams)
          .to.have.property("selected_filters")
          .to.deep.equal(v2Parameters.selectedFilters);
        expect(bodyParams)
      ...
      // eslint-disable-next-line max-len
      expect(
        tracker.trackSearchResultClickV2(term, {
          ...requiredParameters,
          ...optionalParameters,
          ...v2Parameters,
        }),
    ...
    it("Backwards Compatibility - Should respond with a valid response when term and snake cased parameters are provided", (done) => {
      ...
      expect(
        tracker.trackSearchResultClick(term, snakeCaseParameters),
      ).to.equal(true);
    });
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(tracker.trackSearchResultClick(term, requiredParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when term, required parameters and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("result_id")
          .to.equal(optionalParameters.resultId);
        expect(requestParams)
          .to.have.property("variation_id")
          .to.equal(optionalParameters.variationId);
        expect(requestParams)
      ...
      expect(
        tracker.trackSearchResultClick(
          term,
    ...
    it("Should respond with a valid response when term and legacy parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("customer_id")
          .to.equal(legacyParameters.customerId);
        expect(requestParams)
          .to.have.property("name")
          .to.equal(legacyParameters.name);
      ...
      expect(tracker.trackSearchResultClick(term, legacyParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when term and item_is_convertible are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        validateOriginReferrer(requestParams);
        expect(requestParams)
          .to.have.property("item_is_convertible")
          .to.equal("false");
    ...
    it("Should throw an error when invalid term is provided", () => {
      ...
      expect(tracker.trackSearchResultClick([], requiredParameters)).to.be.an(
        "error",
      );
    });
    ...
    it("Should throw an error when no term is provided", () => {
      ...
      expect(tracker.trackSearchResultClick(null, requiredParameters)).to.be.an(
        "error",
      );
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackSearchResultClick(term, requiredParameters, {
            timeout: 10,
          }),
        ).to.equal(true);
      });
  ...
  describe("trackConversion", () => {
    ...
    it("Backwards Compatibility - Should respond with a valid response when term and snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(snakeCaseParameters.revenue.toString());
        validateOriginReferrer(requestParams);
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("revenue")
          .to.equal(requiredParameters.revenue.toString());
        validateOriginReferrer(requestParams);
    ...
    it("Should respond with a valid response when term, required parameters, and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(queryParams)
          .to.have.property("section")
          .to.equal(optionalParameters.section);
        expect(requestParams).to.have.property("key");
        expect(requestParams).to.have.property("i");
        expect(requestParams).to.have.property("s");
        expect(requestParams).to.have.property("c").to.equal(clientVersion);
        ...
        expect(requestParams)
          .to.have.property("item_name")
          .to.equal(optionalParameters.itemName);
        expect(requestParams)
          .to.have.property("variation_id")
          .to.equal(optionalParameters.variationId);
        expect(requestParams)
    ...
    it("Should respond with a valid response when term, required parameters and custom conversion type are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(fullParameters.type);
        expect(requestParams)
          .to.have.property("is_custom_type")
          .to.equal(fullParameters.isCustomType);
        expect(requestParams)
          .to.have.property("display_name")
          .to.equal(fullParameters.displayName);
    ...
    it("should support v1 endpoint arguments", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("item_id")
          .to.equal(parameters.customerId);
        expect(requestParams)
          .to.have.property("item_name")
          .to.equal(parameters.name);
        expect(requestParams)
          .to.have.property("revenue")
          .to.equal(parameters.revenue.toString());
        expect(requestParams)
          .to.have.property("section")
          .to.equal(parameters.section);
        validateOriginReferrer(requestParams);
    ...
    it("Should trim term parameter if extra spaces are provided", (done) => {
      ...
      expect(tracker.trackConversion(spaceTerm, requiredParameters)).to.equal(
        true,
      );
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackConversion(term, requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
      ...
      it("Should be rejected when global network request timeout is provided and reached", (done) => {
        ...
        expect(tracker.trackConversion(term, requiredParameters)).to.equal(
          true,
        );
      });
    }
    ...
    it("Should respond with a valid response when analyticsTags are provided", (done) => {
      ...
      expect(
        tracker.trackConversion(term, parametersWithAnalyticsTags),
      ).to.equal(true);
    });
  });
  ...
  describe("trackPurchase", () => {
    ...
    it("Backwards Compatibility - Should respond with a valid response when snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("items")
          .to.deep.equal(snakeCaseParameters.items);
        expect(requestParams)
          .to.have.property("revenue")
          .to.equal(snakeCaseParameters.revenue);
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("items")
          .to.deep.equal(snakeCaseItems);
        expect(requestParams)
          .to.have.property("revenue")
          .to.equal(requiredParameters.revenue);
    ...
    it("Should send along document_referrer and canonical_url query param", (done) => {
      ...
      expect(
        tracker.trackPurchase({ ...requiredParameters, ...optionalParameters }),
      ).to.equal(true);
    });
    ...
    it("Should respond with a valid response when optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestQueryParams)
          ...
          .to.equal(optionalParameters.section);
        expect(requestBodyParams)
          .to.have.property("order_id")
          .to.equal(optionalParameters.orderId);
        expect(requestBodyParams)
          .to.have.property("analytics_tags")
          .to.deep.equal(testAnalyticsTag);
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackPurchase(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackRecommendationView", () => {
    ...
    it("Backwards Compatibility - Should respond with a valid response when snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(snakeCaseParameters.url);
        expect(requestParams)
          .to.have.property("pod_id")
          .to.equal(snakeCaseParameters.pod_id);
        expect(requestParams)
          .to.have.property("num_results_viewed")
          .to.equal(snakeCaseParameters.num_results_viewed);
        validateOriginReferrer(requestParams);
      ...
      expect(tracker.trackRecommendationView(snakeCaseParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("url")
          .to.equal(requiredParameters.url);
        expect(requestParams)
          .to.have.property("pod_id")
          .to.equal(requiredParameters.podId);
        expect(requestParams)
          .to.have.property("num_results_viewed")
          .to.equal(requiredParameters.numResultsViewed);
        validateOriginReferrer(requestParams);
      ...
      expect(tracker.trackRecommendationView(requiredParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required parameters and items are provided", (done) => {
      const items = [{ itemId: "123", variationId: "234" }, { itemId: "abc" }];
      const snakeCaseItems = [
      ...
      expect(
        tracker.trackRecommendationView({ items, ...requiredParameters }),
      ).to.equal(true);
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("result_count")
          .to.equal(optionalParameters.resultCount);
        expect(requestParams)
          .to.have.property("result_page")
          .to.equal(optionalParameters.resultPage);
        expect(requestParams)
          .to.have.property("result_id")
          .to.equal(optionalParameters.resultId);
        expect(requestParams)
      ...
      expect(
        tracker.trackRecommendationView({
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackRecommendationView(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
    ...
    it("Should respond with a valid response when seedItemIds is an array", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(fetchSpy).to.have.been.called;
        expect(requestParams)
          .to.have.property("seed_item_ids")
          .to.deep.equal(["123"]);
      ...
      expect(
        tracker.trackRecommendationView(requiredParamsWithSeedItemIds),
      ).to.equal(true);
    });
  ...
  describe("trackRecommendationClick", () => {
    ...
    it("Backwards Compatibility - Should respond with a valid response when snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(snakeCaseParameters.pod_id);
        expect(requestParams)
          .to.have.property("strategy_id")
          .to.equal(snakeCaseParameters.strategy_id);
        expect(requestParams)
          .to.have.property("item_id")
          .to.equal(snakeCaseParameters.item_id);
        validateOriginReferrer(requestParams);
      ...
      expect(tracker.trackRecommendationClick(snakeCaseParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("strategy_id")
          .to.equal(requiredParameters.strategyId);
        expect(requestParams)
          .to.have.property("item_id")
          .to.equal(requiredParameters.itemId);
        validateOriginReferrer(requestParams);
      ...
      expect(tracker.trackRecommendationClick(requiredParameters)).to.equal(
        true,
      );
    });
    ...
    it("Backwards Compatibility - Should respond with a valid response when only item_name is provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("pod_id")
          .to.equal(parametersWithItemName.pod_id);
        expect(requestParams)
          .to.have.property("strategy_id")
          .to.equal(parametersWithItemName.strategy_id);
        expect(requestParams)
          .to.have.property("item_name")
          .to.equal(parametersWithItemName.item_name);
        validateOriginReferrer(requestParams);
      ...
      expect(tracker.trackRecommendationClick(parametersWithItemName)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when only item_name is provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("pod_id")
          .to.equal(parametersWithItemName.podId);
        expect(requestParams)
          .to.have.property("strategy_id")
          .to.equal(parametersWithItemName.strategyId);
        expect(requestParams)
          .to.have.property("item_name")
          .to.equal(parametersWithItemName.itemName);
        validateOriginReferrer(requestParams);
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("result_position_on_page")
          .to.equal(optionalParameters.resultPositionOnPage);
        expect(requestParams)
          .to.have.property("num_results_per_page")
          .to.equal(optionalParameters.numResultsPerPage);
        expect(requestParams)
          .to.have.property("result_count")
          .to.equal(optionalParameters.resultCount);
        expect(requestParams)
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackRecommendationClick(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
    ...
    it("Should respond with a valid response when seedItemIds is provided as an array of strings", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("seed_item_ids")
          .to.deep.equal(["item-123", "item-456", "item-789"]);
        // Response
        expect(responseParams).to.have.property("method").to.equal("POST");
        expect(responseParams).to.have.property("message");
        done();
  ...
  describe("trackBrowseResultsLoaded", () => {
    ...
    it("Backwards Compatibility - Should respond with a valid response when snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(snakeCaseParameters.sort_order);
        expect(requestParams)
          .to.have.property("filter_name")
          .to.equal(snakeCaseParameters.filter_name);
        expect(requestParams)
          .to.have.property("filter_value")
          .to.equal(snakeCaseParameters.filter_value);
        expect(requestParams)
          .to.have.property("url")
          .to.equal(snakeCaseParameters.url);
        validateOriginReferrer(requestParams);
      ...
      expect(tracker.trackBrowseResultsLoaded(snakeCaseParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("sort_by")
          .to.equal(requiredParameters.sortBy);
        expect(requestParams)
          .to.have.property("sort_order")
          .to.equal(requiredParameters.sortOrder);
        expect(requestParams)
          .to.have.property("filter_name")
          .to.equal(requiredParameters.filterName);
        expect(requestParams)
          .to.have.property("filter_value")
          .to.equal(requiredParameters.filterValue);
        expect(requestParams)
          .to.have.property("url")
          .to.equal(requiredParameters.url);
        validateOriginReferrer(requestParams);
      ...
      expect(tracker.trackBrowseResultsLoaded(requiredParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("selected_filters")
          .to.deep.equal(optionalParameters.selectedFilters);
        expect(requestParams)
          .to.have.property("items")
          .to.deep.equal(snakeCaseItems);
        expect(requestParams)
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackBrowseResultsLoaded(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackBrowseRedirect", () => {
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(requiredParameters.filterValue);
        expect(requestParams)
          .to.have.property("search_term")
          .to.equal(requiredParameters.searchTerm);
        validateOriginReferrer(requestParams);
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(optionalParameters.redirectToUrl);
        expect(requestParams)
          .to.have.property("user_input")
          .to.equal(optionalParameters.userInput);
        expect(requestParams)
          .to.have.property("selected_filters")
          .to.deep.equal(optionalParameters.selectedFilters);
        expect(requestParams)
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackBrowseRedirect(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackBrowseResultClick", () => {
    ...
    it("Backwards Compatibility - Should respond with a valid response when snake cased parameters are provided", (done) => {
      ...
      expect(tracker.trackBrowseResultClick(snakeCaseParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      expect(
        tracker.trackBrowseResultClick({
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    it("Should respond with a valid response when required parameters and non-existent item id are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("result_count")
          .to.equal(parameters.resultCount);
        expect(requestParams)
          .to.have.property("result_page")
          .to.equal(parameters.resultPage);
        expect(requestParams)
          .to.have.property("result_id")
          .to.equal(parameters.resultId);
        expect(requestParams)
          .to.have.property("result_position_on_page")
          .to.equal(parameters.resultPositionOnPage);
        expect(requestParams)
          .to.have.property("num_results_per_page")
          .to.equal(parameters.numResultsPerPage);
        expect(requestParams)
          .to.have.property("selected_filters")
          .to.deep.equal(parameters.selectedFilters);
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackBrowseResultClick(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
      ...
      it("Should be rejected when global network request timeout is provided and reached", (done) => {
        ...
        expect(tracker.trackBrowseResultClick(requiredParameters)).to.equal(
          true,
        );
      });
    }
  ...
  describe("trackGenericResultClick", () => {
    ...
    it("Backwards Compatibility - Should respond with a valid response when snake cased parameters are provided", (done) => {
      ...
      expect(tracker.trackGenericResultClick(snakeCaseParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      expect(tracker.trackGenericResultClick(requiredParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      expect(
        tracker.trackGenericResultClick({
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    it("Should respond with a valid response when required parameters and non-existent item id are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("item_id")
          .to.equal(parameters.itemId);
        expect(requestParams)
          .to.have.property("item_name")
          .to.deep.equal(parameters.itemName);
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackGenericResultClick(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackQuizResultsLoaded", () => {
    ...
    it("Backwards Compatibility - Should respond with a valid response when snake cased parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(snakeCaseParameters.quiz_id);
        expect(requestParams)
          .to.have.property("quiz_version_id")
          .to.equal(snakeCaseParameters.quiz_version_id);
        expect(requestParams)
          .to.have.property("url")
          .to.equal(snakeCaseParameters.url);
        expect(requestParams)
      ...
      expect(tracker.trackQuizResultsLoaded(snakeCaseParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("quiz_id")
          .to.equal(requiredParameters.quizId);
        expect(requestParams)
          .to.have.property("quiz_version_id")
          .to.equal(requiredParameters.quizVersionId);
        expect(requestParams)
          .to.have.property("url")
          .to.equal(requiredParameters.url);
        expect(requestParams)
      ...
      expect(
        tracker.trackQuizResultsLoaded({
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    it("Should throw an error when invalid quizId is provided", () => {
      ...
      expect(
        tracker.trackQuizResultsLoaded({ ...requiredParameters, quizId: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid url is provided", () => {
      ...
      expect(
        tracker.trackQuizResultsLoaded({ ...requiredParameters, url: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid section is provided", () => {
      ...
      expect(
        tracker.trackQuizResultsLoaded({ ...requiredParameters, section: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid resultId is provided", () => {
      ...
      expect(
        tracker.trackQuizResultsLoaded({ ...requiredParameters, resultId: 1 }),
      ).to.be.an("error");
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackQuizResultsLoaded(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
      ...
      it("Should be rejected when global network request timeout is provided and reached", (done) => {
        ...
        expect(tracker.trackQuizResultsLoaded(requiredParameters)).to.equal(
          true,
        );
      });
    }
  ...
  describe("trackQuizResultClick", () => {
    ...
    it("Should throw an error when invalid quizId is provided", () => {
      ...
      expect(
        tracker.trackQuizResultClick({ ...requiredParameters, quizId: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid itemId is provided", () => {
      ...
      expect(
        tracker.trackQuizResultClick({ ...requiredParameters, itemId: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid itemName is provided", () => {
      ...
      expect(
        tracker.trackQuizResultClick({ ...requiredParameters, itemName: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid resultId is provided", () => {
      ...
      expect(
        tracker.trackQuizResultClick({ ...requiredParameters, resultId: 1 }),
      ).to.be.an("error");
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackQuizResultClick(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackQuizConversion", () => {
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          .to.have.property("type")
          .to.equal(optionalParameters.type);
        expect(requestParams)
          .to.have.property("revenue")
          .to.equal(optionalParameters.revenue);
        expect(requestParams)
          .to.have.property("is_custom_type")
          .to.equal(optionalParameters.isCustomType);
        expect(requestParams)
          .to.have.property("display_name")
          .to.equal(optionalParameters.displayName);
    ...
    it("Should throw an error when invalid quizId is provided", () => {
      ...
      expect(
        tracker.trackQuizConversion({ ...requiredParameters, quizId: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid itemId is provided", () => {
      ...
      expect(
        tracker.trackQuizConversion({ ...requiredParameters, itemId: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid itemName is provided", () => {
      ...
      expect(
        tracker.trackQuizConversion({ ...requiredParameters, itemName: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid section is provided", () => {
      ...
      expect(
        tracker.trackQuizConversion({ ...requiredParameters, section: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid variationId is provided", () => {
      ...
      expect(
        tracker.trackQuizConversion({ ...requiredParameters, variationId: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid type is provided", () => {
      ...
      expect(
        tracker.trackQuizConversion({ ...requiredParameters, type: 0 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid revenue is provided", () => {
      ...
      expect(
        tracker.trackQuizConversion({ ...requiredParameters, revenue: 1 }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when invalid displayName is provided", () => {
      ...
      expect(
        tracker.trackQuizConversion({ ...requiredParameters, displayName: 0 }),
      ).to.be.an("error");
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackQuizConversion(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackAgentSubmit", () => {
    ...
    it("Should respond with a valid response when intent and required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams).to.have.property("_dt");
        expect(requestParams)
          .to.have.property("intent")
          .to.equal(requiredParameters.intent);
        validateOriginReferrer(requestParams);
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams).to.have.property("section").to.equal("Products");
        expect(requestParams)
          .to.have.property("thread_id")
          .to.equal(optionalParameters.threadId);
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackAgentSubmit()).to.be.an("error");
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackAgentSubmit(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackAgentResultLoadStarted", () => {
    const requiredParameters = { intent: "Show me cookie recipes" };
    const optionalParameters = {
      section: "Products",
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(tracker.trackAgentResultLoadStarted(requiredParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(optionalParameters.section);
        expect(requestParams)
          .to.have.property("intent_result_id")
          .to.equal(optionalParameters.intentResultId);
        expect(requestParams)
          .to.have.property("thread_id")
          .to.equal(optionalParameters.threadId);
      ...
      // eslint-disable-next-line max-len
      expect(
        tracker.trackAgentResultLoadStarted({
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackAgentResultLoadStarted()).to.be.an("error");
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackAgentResultLoadStarted(requiredParameters, {
            timeout: 10,
          }),
        ).to.equal(true);
      });
  ...
  describe("trackAgentResultLoadFinished", () => {
    const requiredParameters = {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(requiredParameters.intent);
        expect(requestParams)
          .to.have.property("search_result_count")
          .to.equal(requiredParameters.searchResultCount);
        validateOriginReferrer(requestParams);
      ...
      expect(tracker.trackAgentResultLoadFinished(requiredParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      // eslint-disable-next-line max-len
      expect(
        tracker.trackAgentResultLoadFinished({
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackAgentResultLoadFinished()).to.be.an("error");
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackAgentResultLoadFinished(requiredParameters, {
            timeout: 10,
          }),
        ).to.equal(true);
      });
  ...
  describe("trackAgentResultClick", () => {
    const requiredParameters = {
      intent: "Show me cookie recipes",
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(requiredParameters.intent);
        expect(requestParams)
          .to.have.property("search_result_id")
          .to.equal(requiredParameters.searchResultId);
        expect(requestParams)
          .to.have.property("item_name")
          .to.equal(requiredParameters.itemName);
        expect(requestParams)
    ...
    it("Should throw an error when invalid parameters are provided", () => {
      ...
      expect(tracker.trackAgentResultClick([])).to.be.an("error");
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackAgentResultClick(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
      ...
      it("Should be rejected when global network request timeout is provided and reached", (done) => {
        ...
        expect(tracker.trackAgentResultClick(requiredParameters)).to.equal(
          true,
        );
      });
    }
  ...
  describe("trackAgentResultView", () => {
    ...
    it("Should throw an error when invalid parameters are provided", () => {
      ...
      expect(tracker.trackAgentResultView([])).to.be.an("error");
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackAgentResultView(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackAgentSearchSubmit", () => {
    const requiredParameters = {
      intent: "Show me cookie recipes",
      searchTerm: "Flour",
      searchResultId: "123",
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      expect(
        tracker.trackAgentSearchSubmit({
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackAgentSearchSubmit()).to.be.an("error");
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackAgentSearchSubmit(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
      ...
      it("Should be rejected when global network request timeout is provided and reached", (done) => {
        ...
        expect(tracker.trackAgentSearchSubmit(requiredParameters)).to.equal(
          true,
        );
      });
    }
  ...
  describe("trackAssistantSubmit", () => {
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackAssistantSubmit(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackAssistantResultLoadStarted", () => {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(
        tracker.trackAssistantResultLoadStarted(requiredParameters),
      ).to.equal(true);
    });
  ...
  describe("trackAssistantResultLoadFinished", () => {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(
        tracker.trackAssistantResultLoadFinished(requiredParameters),
      ).to.equal(true);
    });
  ...
  describe("trackAssistantResultClick", () => {
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      expect(tracker.trackAssistantResultClick(requiredParameters)).to.equal(
        true,
      );
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackAssistantResultClick(requiredParameters, {
            timeout: 10,
          }),
        ).to.equal(true);
      });
  ...
  describe("trackAssistantResultView", () => {
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      expect(tracker.trackAssistantResultView(requiredParameters)).to.equal(
        true,
      );
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackAssistantResultView(requiredParameters, { timeout: 10 }),
        ).to.equal(true);
      });
  ...
  describe("trackAssistantSearchSubmit", () => {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(tracker.trackAssistantSearchSubmit(requiredParameters)).to.equal(
        true,
      );
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackAssistantSearchSubmit(requiredParameters, {
            timeout: 10,
          }),
        ).to.equal(true);
      });
  ...
  describe("trackProductInsightsAgentViews", () => {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.deep.equal(requiredParameters.questions);
        expect(requestParams)
          .to.have.property("view_timespans")
          .to.deep.equal(requiredParameters.viewTimespans);
        validateOriginReferrer(requestParams);
      ...
      expect(
        tracker.trackProductInsightsAgentViews(requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackProductInsightsAgentViews()).to.be.an("error");
    });
  ...
  describe("trackProductInsightsAgentView", () => {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(
        tracker.trackProductInsightsAgentView(requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackProductInsightsAgentView()).to.be.an("error");
    });
  ...
  describe("trackProductInsightsAgentOutOfView", () => {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(
        tracker.trackProductInsightsAgentOutOfView(requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackProductInsightsAgentOutOfView()).to.be.an("error");
    });
  ...
  describe("trackProductInsightsAgentFocus", () => {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(
        tracker.trackProductInsightsAgentFocus(requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      expect(
        tracker.trackProductInsightsAgentFocus({
          ...requiredParameters,
          ...optionalParameters,
        }),
      ).to.equal(true);
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackProductInsightsAgentFocus()).to.be.an("error");
    });
  ...
  describe("trackProductInsightsAgentQuestionClick", () => {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(requiredParameters.question);
        validateOriginReferrer(requestParams);
      ...
      expect(
        tracker.trackProductInsightsAgentQuestionClick(requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(bodyParams)
          ...
          .to.equal(optionalParameters.threadId);
        expect(bodyParams)
          .to.have.property("question_topic")
          .to.equal(optionalParameters.questionTopic);
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackProductInsightsAgentQuestionClick()).to.be.an(
        "error",
      );
    });
  ...
  describe("trackProductInsightsAgentQuestionSubmit", () => {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      expect(
        tracker.trackProductInsightsAgentQuestionSubmit(requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackProductInsightsAgentQuestionSubmit()).to.be.an(
        "error",
      );
    });
  ...
  describe("trackProductInsightsAgentAnswerView", () => {
    ...
    const optionalParameters = {
      ...
      threadId: "thread-123",
      items: [
        { itemId: "rec1", itemName: "Rec Product 1" },
        { itemId: "rec2", itemName: "Rec Product 2" },
      ],
      followUpQuestions: [
        { value: "What about size?" },
        { value: "Is it machine washable?" },
      ],
    };
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(requiredParameters.question);
        expect(requestParams)
          .to.have.property("answer_text")
          .to.equal(requiredParameters.answerText);
        validateOriginReferrer(requestParams);
      ...
      expect(
        tracker.trackProductInsightsAgentAnswerView(requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(bodyParams)
          ...
          .to.equal(optionalParameters.variationId);
        expect(bodyParams)
          .to.have.property("qna_result_id")
          .to.equal(optionalParameters.qnaResultId);
        expect(bodyParams)
          .to.have.property("thread_id")
          .to.equal(optionalParameters.threadId);
        expect(bodyParams)
          ...
          .to.be.an("array")
          .with.lengthOf(2);
        expect(bodyParams.items[0])
          .to.have.property("item_id")
          .to.equal("rec1");
        expect(bodyParams.items[0])
          .to.have.property("item_name")
          .to.equal("Rec Product 1");
        expect(bodyParams)
          .to.have.property("follow_up_questions")
          .to.be.an("array")
          .with.lengthOf(2);
        expect(bodyParams.follow_up_questions[0])
          .to.have.property("value")
          .to.equal("What about size?");
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackProductInsightsAgentAnswerView()).to.be.an("error");
    });
  ...
  describe("trackProductInsightsAgentAnswerFeedback", () => {
    ...
    it("Should respond with a valid response when term and required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(requiredParameters.itemName);
        expect(requestParams)
          .to.have.property("feedback_label")
          .to.equal(requiredParameters.feedbackLabel);
        validateOriginReferrer(requestParams);
      ...
      expect(
        tracker.trackProductInsightsAgentAnswerFeedback(requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should throw an error when no parameters are provided", () => {
      ...
      expect(tracker.trackProductInsightsAgentAnswerFeedback()).to.be.an(
        "error",
      );
    });
  ...
  describe("trackProductInsightsAgentResultClick", () => {
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(requestParams)
          ...
          .to.equal(requiredParameters.question);
        expect(requestParams)
          .to.have.property("seed_item_id")
          .to.equal(requiredParameters.seedItemId);
        validateOriginReferrer(requestParams);
      ...
      expect(
        tracker.trackProductInsightsAgentResultClick(requiredParameters),
      ).to.equal(true);
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(bodyParams)
          ...
          .to.equal(optionalParameters.position);
        expect(bodyParams)
          .to.have.property("seed_item_name")
          .to.equal(optionalParameters.seedItemName);
        expect(bodyParams)
          .to.have.property("seed_variation_id")
          .to.equal(optionalParameters.seedVariationId);
        expect(bodyParams)
          .to.have.property("thread_id")
          .to.equal(optionalParameters.threadId);
        expect(bodyParams)
    ...
    it("Should throw an error when invalid parameters are provided", () => {
      ...
      expect(tracker.trackProductInsightsAgentResultClick("invalid")).to.be.an(
        "error",
      );
    });
  ...
  describe("trackResultsImpressionView", () => {
    ...
    it("Should respond with a valid response when required parameters are provided", (done) => {
      ...
      expect(tracker.trackResultsImpressionView(requiredParameters)).to.equal(
        true,
      );
    });
    ...
    it("Should respond with a valid response when required and optional parameters are provided", (done) => {
      ...
      tracker.on("success", (responseParams) => {
        ...
        expect(bodyParams)
          .to.have.property("filter_name")
          .to.equal(optionalParameters.filterName);
        expect(bodyParams)
          .to.have.property("filter_value")
          .to.equal(optionalParameters.filterValue);
        expect(bodyParams)
          .to.have.property("search_term")
          .to.equal(optionalParameters.searchTerm);
    ...
    it("Should throw an error when items is an empty array", () => {
      ...
      expect(tracker.trackResultsImpressionView({ items: [] })).to.be.an(
        "error",
      );
    });
    ...
    it("Should throw an error when an item is missing itemId", () => {
      ...
      expect(
        tracker.trackResultsImpressionView({ items: [{ itemName: "Shoe" }] }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when an item is missing itemName", () => {
      ...
      expect(
        tracker.trackResultsImpressionView({ items: [{ itemId: "1" }] }),
      ).to.be.an("error");
    });
    ...
    it("Should throw an error when items contains non-object entries", () => {
      ...
      expect(
        tracker.trackResultsImpressionView({ items: ["string"] }),
      ).to.be.an("error");
    });
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackResultsImpressionView(requiredParameters, {
            timeout: 10,
          }),
        ).to.equal(true);
      });
  ...
  describe("trackMediaImpressionView", () => {
    ...
    before(async () => {
      const response = await fetch(
        `https://display.media-cnstrc.com/display-ads?key=${testApiKeyWithAdPlacements}&placement_ids=${testPlacementId}`,
      );
  ...
  describe("trackMediaImpressionClick", () => {
    ...
    if (!skipNetworkTimeoutTests) {
      it("Should be rejected when network request timeout is provided and reached", (done) => {
        ...
        expect(
          tracker.trackMediaImpressionClick(requiredParameters, {
            timeout: 10,
          }),
        ).to.equal(true);
      });
